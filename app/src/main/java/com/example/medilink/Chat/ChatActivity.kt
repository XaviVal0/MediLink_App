...
import com.example.medilink.Adaptadores.AdaptadorChat
        ...
        ref.child(chatRuta)
            .addValueEventListener(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.ChatsRv.setHasFixedSize(true)
                    var linearLayoutManeger2 = LinearLayoutManager(this@ChatActivity)
                    linearLayoutManeger2.stackFromEnd = true
                    binding.ChatsRv.layoutManager = linearLayoutManeger2
                }
            ...
            .addValueEventListener(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    try {
                        ...
                        binding.TxtNombreChat.text = nombre
